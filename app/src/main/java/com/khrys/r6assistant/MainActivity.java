...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button buttonguns = (Button) findViewById(R.id.buttonmain4);
        Button buttonmore = (Button) findViewById(R.id.buttonMore);
        ImageButton buttonset = (ImageButton) findViewById(R.id.buttonSettings);

        buttonguns.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Intent mIntent = new Intent(MainActivity.this, WeaponMenuActivity.class);
                startActivity(mIntent);
            }
        });

        buttonguns.setOnLongClickListener(new View.OnLongClickListener()
        {
            @Override
        ...
        buttonmore.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                final String[] items = {getResources().getString(R.string.about), getResources().getString(R.string.support)};
